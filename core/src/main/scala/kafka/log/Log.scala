...
class Log(@volatile var dir: File,
  ...
  /*
    The segments marked for deletion.
    On Windows, the file handles must be cleaned up correctly when closing or deleting the log.
  ...
  /**
    * All the log segments marked for deletion
    */
